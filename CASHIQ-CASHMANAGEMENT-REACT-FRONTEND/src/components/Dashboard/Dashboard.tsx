...
const Dashboard: React.FC = () => {
    ...
    useEffect(() => {
        const loadDashboardData = async () => {
            ...
            try {
                ...
                // --- Calculate Metrics ---
                const { monthlyIncome, incomeTitle, incomeSubtext } = calculateIncomeMetrics(fetchedTransactions);
                const { monthlyExpense, expenseSubtext } = calculateExpenseMetrics(fetchedTransactions);
                const totalDebt = calculateDebtMetrics(fetchedDebts);
                ...
                setIncomeTitle(incomeTitle);
                setIncomeSubtext(incomeSubtext);
                
                setMonthlyExpense(monthlyExpense);
                setExpenseSubtext(expenseSubtext);
    ...
    const { safeToSpend, safeToSpendSubtext, safeToSpendClass } = calculateBudgetMetrics(budgets, monthlyExpense);
